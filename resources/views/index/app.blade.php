...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-800">
        <header class="p-5  bg-gray-400 shadow">
            <div class="container mx-auto flex justify-between items-center">
                ...
                <nav class="flex gap items-center">
                    ...
                    <a class="font-bold uppercase text-gray-600" href="/registrate">crear cuenta</a>
                    <a class="font-bold uppercase text-gray-600" href="/principal">principal</a>
                </nav>
            </div>
        ...
        <footer class=" mt-10 text-center p-5 text-gray-200 font-bold uppercase">
